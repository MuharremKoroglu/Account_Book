...
With this application, users can save login information. We used the UserDefaults class to register the user name and password. We saved the data with the set method of this class. We used it where we wanted to show the data held with the Object method. In addition, we performed the deletion of the recorded data with the removeObject method. Finally, we placed a special icon in our application.
...
https://user-images.githubusercontent.com/68854616/190408330-380071b7-3fe8-4f44-bfe8-c6d003c3189d.mp4
